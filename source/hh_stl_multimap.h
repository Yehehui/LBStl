#ifndef __HH_STL_MULTIMAP_H_
#define __HH_STL_MULTIMAP_H_
...
public:
    ...
    typedef T data_type;
    typedef hh_std::pair<key_type, data_type> value_type;
...
public:
    ...
    multimap(): t(Compare()) {}
    explicit multimap(Compare &c): t(c) {}
    template <class InputIterator>
    multimap(InputIterator first, InputIterator last): t(Compare()) {
        t.insert_equal(first, last);
    }
    template <class InputIterator>
    multimap(InputIterator first, InputIterator last, Compare &c): t(c) {
        t.insert_equal(first, last);
    }
